...
CREATE TABLE `menu_has_order` (
  ...
  CONSTRAINT `fk_Menu_has_Order_Order1` FOREIGN KEY (`Order_Order_ID`) REFERENCES `order` (`Order_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `fk_Order_Table1` FOREIGN KEY (`Table_Table_ID`) REFERENCES `table` (`Table_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `order` VALUES (101,'John Doe','12:30',1),(102,'Mary Smith','13:00',2),(103,'James Wilson','18:30',3),(104,'Patricia Taylor','19:00',4),(105,'Robert Moore','19:15',5),(106,'Linda Anderson','20:00',6),(107,'Michael Thomas','12:45',7),(108,'Barbara White','13:15',8),(109,'William Harris','18:45',9),(110,'Elizabeth Martin','19:30',10);
...
INSERT INTO `table` VALUES (1,'Window','5','$44.91'),(2,'Middle #2','2','$25.89'),(3,'Patio','4','$65.20'),(4,'Bar','1','$15.00'),(5,'Corner Booth','6','$120.50'),(6,'Window','2','$35.45'),(7,'Middle #3','4','$55.00'),(8,'Kitchen View','2','$42.10'),(9,'Patio','4','$70.00'),(10,'Private Room','10','$250.00');
...
-- Dump completed on 2026-04-27  0:19:46
